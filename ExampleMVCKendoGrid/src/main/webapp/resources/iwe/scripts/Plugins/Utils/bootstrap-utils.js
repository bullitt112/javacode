...
!function ($) {
  ...
  , show: function () {
      ...
      if (this.hasContent() && this.enabled) {
          ...
          //add in different stylings
          var type = this.options.type;

          switch (type) {
              case "normal":
              default:
                  $tip.addClass("popover-normal");
                  break;
              case "narrow":
                  $tip.addClass("popover-narrow");
                  break;
              case "wide":
                  $tip.addClass("popover-wide");
                  break;
          }
  ...
  , applyPlacement: function (offset, placement) {
      ...
      if (placement == 'bottom' || placement == 'top' || placement == 'icon') {
          delta = 0
  ...
  , setContent: function () {
      ...
      $tip.removeClass('fade in top bottom left right icon')
  }
...
!function ($) {
  ...
  , setContent: function () {
      ...
      $tip.removeClass('fade top bottom left right in icon')
  }
