...
public class PeakCustomerInfo implements Serializable {
		...
		public String getNaturalGasContractExpiration() {
			return getNaturalGasContractExpiration();
		}
		public void setNaturalGasContractExpiration(String naturalGasContractExpiration) {
